...
- Follow-up interpretation: declared downstream tools are `api_schema_discovery, passive_config_audit`; treat them as investigation candidates rather than automatic proof.
