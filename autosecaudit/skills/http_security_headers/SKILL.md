...
Use this skill when the declarative manifest has already selected `http_security_headers` and an operator needs the human-readable intent behind the recon workflow.

## Intent

- Validate common HTTP security headers on reachable origins.
