...
- Follow-up interpretation: declared downstream tools are `no declarative follow-up tools`; treat them as investigation candidates rather than automatic proof.
