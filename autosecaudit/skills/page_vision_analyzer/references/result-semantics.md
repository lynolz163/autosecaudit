...
- Follow-up interpretation: declared downstream tools are `cookie_security_audit, login_form_detector, nuclei_exploit_check, passive_config_audit`; treat them as investigation candidates rather than automatic proof.
