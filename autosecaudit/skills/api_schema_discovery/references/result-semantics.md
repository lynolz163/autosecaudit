...
- Follow-up interpretation: declared downstream tools are `cookie_security_audit, param_fuzzer`; treat them as investigation candidates rather than automatic proof.
