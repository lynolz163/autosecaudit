...
- Follow-up interpretation: declared downstream tools are `cors_misconfiguration, http_security_headers, passive_config_audit, security_txt_check, ssl_expiry_check`; treat them as investigation candidates rather than automatic proof.
