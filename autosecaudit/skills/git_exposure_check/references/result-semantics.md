...
- Follow-up interpretation: declared downstream tools are `passive_config_audit, source_map_detector`; treat them as investigation candidates rather than automatic proof.
