...
Use this skill when the declarative manifest has already selected `xss_protection_audit` and an operator needs the human-readable intent behind the testing workflow.

## Intent

- Probe parameterized endpoints for reflection and output-encoding weaknesses.
