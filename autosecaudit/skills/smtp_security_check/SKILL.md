...
Use this skill when the declarative manifest has already selected `smtp_security_check` and an operator needs the human-readable intent behind the validation workflow.

## Intent

- Collect SMTP banner, EHLO capabilities, and STARTTLS exposure safely.
