...
Use this skill when the declarative manifest has already selected `login_form_detector` and an operator needs the human-readable intent behind the recon workflow.

## Intent

- Detect login and authentication forms from passive page inspection.
...
- downstream investigation candidates currently declared by the manifest: `cookie_security_audit, passive_config_audit`
