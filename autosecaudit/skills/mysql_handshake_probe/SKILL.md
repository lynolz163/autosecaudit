...
Use this skill when the declarative manifest has already selected `mysql_handshake_probe` and an operator needs the human-readable intent behind the validation workflow.

## Intent

- Collect MySQL handshake metadata without attempting authentication.
