...
- Reconfirm scope, authorization, and current mission context before reviewing `mysql_handshake_probe` output.
- Review the intended use: Collect MySQL handshake metadata without attempting authentication.
