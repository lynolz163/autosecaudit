...
Use this skill when the declarative manifest has already selected `ssh_auth_audit` and an operator needs the human-readable intent behind the validation workflow.

## Intent

- Validate SSH authentication surface and record the exposed protocol banner.
