...
- Follow-up interpretation: declared downstream tools are `cve_lookup, nuclei_exploit_check, poc_sandbox_exec`; treat them as investigation candidates rather than automatic proof.
