...
Use this skill when the declarative manifest has already selected `tech_stack_fingerprint` and an operator needs the human-readable intent behind the recon workflow.

## Intent

- Passively fingerprint exposed technologies from headers and page content.
...
- downstream investigation candidates currently declared by the manifest: `api_schema_discovery, csp_evaluator, dirsearch_scan, http_security_headers, nuclei_exploit_check, passive_config_audit, source_map_detector`
