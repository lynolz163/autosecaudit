...
- Follow-up interpretation: declared downstream tools are `reverse_dns_probe, subdomain_enum_passive`; treat them as investigation candidates rather than automatic proof.
