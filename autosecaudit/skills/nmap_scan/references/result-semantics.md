...
- Follow-up interpretation: declared downstream tools are `http_security_headers, passive_config_audit, ssl_expiry_check, tech_stack_fingerprint`; treat them as investigation candidates rather than automatic proof.
