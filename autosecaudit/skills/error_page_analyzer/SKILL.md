...
Use this skill when the declarative manifest has already selected `error_page_analyzer` and an operator needs the human-readable intent behind the recon workflow.

## Intent

- Inspect verbose error pages for stack traces, framework markers, and debug data.
...
- downstream investigation candidates currently declared by the manifest: `passive_config_audit`
