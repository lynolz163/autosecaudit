...
Use this skill when the declarative manifest has already selected `csp_evaluator` and an operator needs the human-readable intent behind the testing workflow.

## Intent

- Evaluate Content-Security-Policy quality and risky directives.
...
- stay inside the declared risk posture: `low` with planner cost `4`
