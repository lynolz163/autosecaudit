# Passive Config Audit

Use this skill when the declarative manifest has already selected `passive_config_audit` and an operator needs the human-readable intent behind the recon workflow.
